<x-home titre="Tableau de Paiement" page_titre="Tableau de Paiement">
    <!-- Page Content -->
    ...
    <div class="max-w-5xl mx-auto space-y-10">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
          ...
          <p class="text-2xl font-bold text-indigo-800">39 970 DHS</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
          ...
          <p class="text-2xl font-bold text-emerald-700">24 000 DHS</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-xl transition">
          ...
          <p class="text-2xl font-bold text-rose-600">15 970 DHS</p>
        </div>
      ...
      <div class="bg-white rounded-3xl shadow-lg p-6 sm:p-8 space-y-5">
        <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 gap-4">
          ...
          <div class="flex gap-2">
            <button id="all" class="filter-btn bg-indigo-100 text-indigo-700 font-medium px-4 py-1 rounded-full hover:bg-indigo-200 transition">Tous</button>
            <button id="cash" class="filter-btn bg-emerald-100 text-emerald-700 font-medium px-4 py-1 rounded-full hover:bg-emerald-200 transition">Cash</button>
            <button id="cheque" class="filter-btn bg-purple-100 text-purple-700 font-medium px-4 py-1 rounded-full hover:bg-purple-200 transition">Chèque</button>
          </div>
        </div>

        <!-- Paiement 1 -->
        <div class="payment-row group payment-cash animate-fade-in flex justify-between items-center border-b pb-4 p-3 rounded-xl transition duration-300 ease-in-out hover:-translate-y-[2px] hover:shadow-lg hover:bg-indigo-50 hover:border-indigo-300">
          <div class="flex items-center gap-4">
            <i class="ph ph-money text-indigo-600 text-2xl group-hover:animate-bounce-slow"></i>
            <div>
              <p class="font-semibold text-gray-700">10 000 DHS</p>
              <p class="text-sm text-gray-400">Cash</p>
            </div>
          </div>
          <p class="text-sm text-gray-500">15 Janv 2025</p>
        </div>
