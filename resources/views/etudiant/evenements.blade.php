        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            @foreach ($evenements->sortByDesc('date') as $evenement)
                ...
                <div class="relative group">
                    ...
                    <div
                        class="h-full flex flex-col justify-between rounded-xl border border-blue-100 shadow-md bg-white p-6 transition-all duration-300 transform hover:shadow-xl hover:-translate-y-1 overflow-hidden {{ $isPast ? 'backdrop-blur-[2px] bg-white/90' : 'bg-gradient-to-br from-blue-50 via-white to-blue-100' }}">
                        <div class="space-y-4">
                            <h2
                                class="text-xl font-bold text-gray-800 group-hover:text-blue-600 transition duration-300">
                                {{ $evenement->titre }}</h2>
                            ...
                            @unless ($isPast)
                                <span
                                    class="inline-block mt-3 px-3 py-1 text-xs font-semibold bg-blue-100 text-blue-700 rounded-full shadow-sm">🆕
                                    Nouveau</span>
                            @else
                                <div
