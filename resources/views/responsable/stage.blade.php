...
<div class="min-h-screen p-4 md:p-6">
    ...
    <div id="delete-modal" class="fixed inset-0 z-50 hidden flex items-center justify-center p-4 bg-black bg-opacity-50">
        <div class="bg-white rounded-xl shadow-xl overflow-hidden w-full max-w-md">
            <div class="p-6">
                ...
                <p class="text-gray-600 text-center mb-6">Êtes-vous sûr de vouloir supprimer ce stage ? Cette action est irréversible.</p>
    ...
    <!-- Message de succès -->
    @if(session('success'))
    <div class="bg-emerald-50 border-l-4 border-emerald-500 text-emerald-800 p-4 mb-6 rounded-lg shadow-sm flex items-start animate-fade-in">
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <div id="stage-form-container" class="hidden bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
            ...
            <form action="{{ route('stages.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
                @csrf
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        <label for="nom_stage" class="block text-sm font-medium text-gray-700 mb-2">Nom du Stage <span class="text-red-500">*</span></label>
                        <input type="text" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition" 
                               id="nom_stage" name="nom_stage" placeholder="Ex: Stage Développement Web" required>
                    </div>
                    
                    <div>
                        <label for="entreprise" class="block text-sm font-medium text-gray-700 mb-2">Entreprise <span class="text-red-500">*</span></label>
                        <input type="text" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition" 
                               id="entreprise" name="entreprise" placeholder="Ex: Google" required>
                    </div>
                    
                    <div>
                        <label for="domaine" class="block text-sm font-medium text-gray-700 mb-2">Domaine <span class="text-red-500">*</span></label>
                        <select id="domaine" name="domaine" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition appearance-none" required>
                    ...
                    <div>
                        <label for="duree" class="block text-sm font-medium text-gray-700 mb-2">Durée <span class="text-red-500">*</span></label>
                        <input type="text" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition" 
                               id="duree" name="duree" placeholder="Ex: 3 mois" required>
                    </div>
                    
                    <div>
                        <label for="email_entreprise" class="block text-sm font-medium text-gray-700 mb-2">Email Entreprise <span class="text-red-500">*</span></label>
                        <input type="email" class="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition" 
                               id="email_entreprise" name="email_entreprise" placeholder="contact@entreprise.com" required>
                    </div>
                    
                    <div class="mb-6">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Logo Entreprise <span class="text-red-500">*</span></label>
                        <div 
                            id="dropZone"
                        ...
                        >
                            ...
                            <div id="imagePreviewContainer" class="hidden absolute inset-0 flex items-center justify-center bg-white">
                ...
                <div>
                    ...
                    <textarea class="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition min-h-[120px]" 
                              id="description" name="description" placeholder="Décrivez les missions du stage..." required></textarea>
                </div>
                
                <div class="pt-2">
                    <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3.5 rounded-lg font-medium flex items-center justify-center transition duration-300 shadow-md hover:shadow-lg">
        ...
        <div id="stages-list-container">
            <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
                ...
                <div class="text-center py-12 bg-gray-50 rounded-b-lg">
                    ...
                    <p class="text-gray-500 max-w-md mx-auto">Commencez par ajouter une nouvelle offre de stage</p>
                </div>
                @else
                    ...
                    <div class="p-6 hover:bg-gray-50 transition duration-150">
                        ...
                        <div class="flex items-start mb-4">
                            <div class="flex-shrink-0 mr-4">
                                <img class="h-14 w-14 rounded-lg object-cover border border-gray-200" src="{{ asset('storage/' . $stage->photo) }}" alt="Logo entreprise">
                            </div>
                            <div class="flex-1 min-w-0">
                                <h3 class="text-lg font-semibold text-gray-900 truncate">{{ $stage->nom_stage }}</h3>
                            ...
                            <div class="ml-4 flex-shrink-0">
                                <div class="flex space-x-2">
                                    ...
                                    <button onclick="showDeleteModal('{{ route('stages.destroy', $stage->id) }}')"
                        ...
                        <div class="pl-18">
                            ...
                            <div class="flex items-center text-sm text-gray-500">
                                ...
                                <a href="mailto:{{ $stage->email_entreprise }}" class="hover:text-indigo-600 hover:underline">{{ $stage->email_entreprise }}</a>
                            </div>
                        </div>
                        
                        <!-- Formulaire d'édition (caché) -->
                        <div id="edit-form-{{ $stage->id }}" class="hidden mt-6 bg-gray-50 p-5 rounded-lg border border-gray-200 animate-slide-down">
                            <h4 class="font-medium text-gray-800 mb-4 flex items-center">
                                <i class="fas fa-edit text-indigo-500 mr-2"></i>
                                Modifier le stage
                            </h4>
                            <form action="{{ route('stages.update', $stage->id) }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                                @csrf
                                @method('PUT')
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Nom</label>
                                        <input type="text" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition" 
                                    ...
                                    <div>
                                        ...
                                        <input type="email" class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition" 
                                               name="email_entreprise" value="{{ $stage->email_entreprise }}" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Logo actuel</label>
                                        <div class="flex items-center space-x-3">
                                            <img src="{{ asset('storage/' . $stage->photo) }}" alt="Logo" class="h-10 rounded-lg object-cover border border-gray-200">
                                    ...
                                    <div class="md:col-span-2">
                                        ...
                                        <input type="file" class="w-full text-sm border border-gray-200 rounded-lg p-2 focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition" 
                                               name="photo" accept="image/*">
                                    </div>
                                    <div class="md:col-span-2">
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Description</label>
                                        <textarea class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 transition min-h-[100px]" 
                                                  name="description" required>{{ $stage->description }}</textarea>
                                    </div>
                                </div>
                                <div class="flex space-x-3 pt-2">
                                    <button type="submit" class="flex-1 bg-green-600 hover:bg-green-700 text-white px-4 py-2.5 rounded-lg font-medium transition duration-300">
                                        <i class="fas fa-save mr-1"></i> Enregistrer
                                    </button>
                                    <button type="button" onclick="toggleEditForm('edit-form-{{ $stage->id }}')" class="flex-1 bg-gray-500 hover:bg-gray-600 text-white px-4 py-2.5 rounded-lg font-medium transition duration-300">
