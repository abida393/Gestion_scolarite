<x-admin titre="Page Events" page_titre="Page events" :nom_complete="Auth::guard('responsable')->user()?->respo_nom . ' ' . Auth::guard('responsable')->user()?->respo_prenom">
    <div>
        <!-- Decorative elements -->
        <div
            class="absolute top-0 right-0 w-32 h-32 bg-blue-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20">
        </div>
        <div
            class="absolute bottom-0 left-0 w-64 h-64 bg-indigo-200 rounded-full mix-blend-multiply filter blur-3xl opacity-20">
        </div>
        ...
        <div id="delete-modal"
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden w-full max-w-md">
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-center mb-6">Êtes-vous sûr de vouloir supprimer cet événement ? Cette
        ...
        <div class="relative max-w-6xl mx-auto z-10">
            ...
            <div class="text-center mb-12">
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                    Gestion des <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Événements</span>
                </h1>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Organisez et planifiez les événements de votre
                    établissement en toute simplicité</p>
            </div>
            ...
            <div class="max-w-5xl mx-auto mb-10 space-y-4">
                @if (session('message'))
                    <div
                        class="p-4 rounded-xl bg-white shadow-md border-l-4 border-emerald-500 flex items-start animate-fade-in">
                ...
                @if (session('error'))
                    <div
                        class="p-4 rounded-xl bg-white shadow-md border-l-4 border-rose-500 flex items-start animate-fade-in">
                        <div class="flex-shrink-0">
            ...
            <div id="event-form-container"
                class="hidden bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden mb-10 transition-all duration-300 hover:shadow-md">
                <div class="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
                    <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-4">
                            <!-- Icône dans un cercle -->
                            <div
                                class="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 shadow-lg">
                ...
                <div class="p-6">
                    <form action="{{ route('responsable.events.store') }}" method="POST"
                        class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        @csrf
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Titre de l'événement <span
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Heure de début <span
                                    class="text-rose-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Heure de fin <span
                                    class="text-rose-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                    <i class="far fa-clock text-gray-400"></i>
                        ...
                        <div class="md:col-span-2 pt-2">
                            <button type="submit"
                                ...
                                <i
                                    class="fas fa-calendar-plus mr-3 transform transition-transform duration-300 group-hover:scale-110"></i>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-100" id="events-list">
                        @forelse ($evenements as $event)
                            <div class="p-6 hover:bg-gray-50 transition-colors duration-200 group event-item"
                                data-title="{{ strtolower($event->titre) }}">
                                <div class="flex flex-col md:flex-row md:items-center gap-6">
                                    <div class="flex-shrink-0">
                                        <div
                                            class="w-16 h-16 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-100 flex items-center justify-center text-blue-500 shadow-inner">
                                    ...
                                    <div class="flex items-center gap-2 mt-4 md:mt-0">
                                        ...
                                        <button
                                            onclick="showDeleteModal('{{ route('responsable.events.destroy', $event->id) }}')"
                                            class="text-sm font-medium px-4 py-2 rounded-lg bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center">
                                ...
                                <div id="edit-form-{{ $event->id }}"
                                    class="hidden mt-6 pt-6 border-t border-gray-100">
                                    <form action="{{ route('responsable.events.update', $event->id) }}"
                                        method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                        @csrf
                                        @method('PUT')

                                        <div class="md:col-span-2">
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Titre <span
                                                    class="text-rose-500">*</span></label>
                                        ...
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Heure début
                                                <span class="text-rose-500">*</span></label>
                                            <input type="time" name="start_time" required
                                                value="{{ \Carbon\Carbon::parse($event->heure_debut)->format('H:i') }}"
                                                class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-200">
                                        </div>

                                        <div>
                                            <label class="block text-sm font-medium text-gray-700 mb-2">Heure fin <span
                                                    class="text-rose-500">*</span></label>
                                            <input type="time" name="end_time" required
                                                value="{{ \Carbon\Carbon::parse($event->heure_fin)->format('H:i') }}"
                                                class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-200">
                                        </div>
                                        ...
                                        <div class="md:col-span-2 flex gap-3 pt-2">
                                            ...
                                            <button type="button"
                                                onclick="toggleEditForm('edit-form-{{ $event->id }}')"
                        ...
                        @empty
                            <div class="p-10 text-center">
                                <div
                                    class="mx-auto w-20 h-20 bg-blue-50 rounded-xl flex items-center justify-center text-blue-400 mb-5">
                                    <i class="fas fa-calendar-times text-3xl"></i>
                                </div>
                                <h3 class="text-lg font-medium text-gray-700 mb-2">Aucun événement programmé</h3>
                                <p class="text-gray-500 text-sm">Créez votre premier événement en utilisant le
