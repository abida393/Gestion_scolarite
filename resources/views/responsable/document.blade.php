            ...
            <div class="flex flex-col gap-6">
                ...
                <div class="relative w-full max-w-2xl">
                    ...
                    <input type="text"
                           ...
                           placeholder="Rechercher par nom ou email étudiant..." 
                           autocomplete="off">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center gap-3 mb-2">
                            ...
                            <span class="status-badge px-3 py-1 rounded-full text-xs font-medium 
                                ...
                                @elseif($demande->etat_demande == 'refus') bg-red-100 text-red-800 ring-1 ring-red-300
                                @endif">
                                ...
                                <div class="relative w-full">
                                    ...
                                    <div class="pointer-events-none absolute inset-y-0 right-3 flex items-center text-slate-500">
                                        <svg class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.292l3.71-4.06a.75.75 0 111.08 1.04l-4.25 4.656a.75.75 0 01-1.08 0L5.21 8.27a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                                        </svg>
                                    </div>
                                </div>

                                <!-- Justification de refus -->
                                <div id="justif-refus-container-{{ $demande->id }}" class="{{ $demande->etat_demande == 'refus' ? 'block' : 'hidden' }}">
                                    <label for="justif_refus-{{ $demande->id }}" class="block text-sm font-medium text-slate-600 mb-1">Justification du refus</label>
