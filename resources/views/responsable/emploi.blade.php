...
@endif -->
        ...
        <div class="bg-white p-6 rounded-lg shadow mb-8 ">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-3 justify-center">
                ...
                <div
                    class="bg-white border border-green-100 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                ...
                <!-- Carte Enseignants -->
                <div
                    class="bg-white border border-yellow-100 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow">
                    <div class="flex items-center">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Créneau
                                </th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($emploisTemps as $emploi)
                                <tr
                                    class="hover:bg-gray-50 @if ($emploi->statut === 'annule') bg-red-50 @elseif($emploi->statut === 'reporte') bg-yellow-50 @endif">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        @if ($emploi->statut === 'annule')
                                            <span
                                                class="px-2 py-1 rounded-full text-xs bg-red-100 text-red-800">Annulé</span>
                                        @elseif($emploi->statut === 'reporte')
                                            <span
                                                class="px-2 py-1 rounded-full text-xs bg-yellow-100 text-yellow-800">Reporté</span>
                                        @else
                                            <span
                                                class="px-2 py-1 rounded-full text-xs bg-green-100 text-green-800">Prévu</span>
                                        @endif
                                    </td>
        ...
        @elseif(request('classe_id'))
            <div class="bg-white p-8 rounded-lg shadow text-center">
                ...
                <p class="mt-1 text-gray-500">Aucun emploi du temps trouvé pour la classe
                    {{ $classes->firstWhere('id', request('classe_id'))->nom_classe }}.</p>
