        ...
        <div id="delete-modal"
            ...
            <div class="bg-white rounded-xl shadow-xl overflow-hidden w-full max-w-md">
                <div class="p-6">
                    ...
                    <p class="text-gray-600 text-center mb-6">Êtes-vous sûr de vouloir supprimer cette actualité ? Cette
        ...
        <div class="relative max-w-6xl mx-auto z-10">
            ...
            <div class="text-center mb-12">
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4">
                    Gestion des <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">Actualités</span>
                </h1>
                <p class="text-lg text-gray-600 max-w-2xl mx-auto">Publiez et gérez les actualités de votre
                    établissement</p>
            </div>
            ...
            <div id="news-form-container"
                ...
                <div class="p-6">
                    <form action="{{ route('news.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Contenu <span
                                    class="text-rose-500">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="date" name="date_news" id="date_news" value="{{ old('date_news') }}"
                                        required
                                        class="pl-10 w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-200">
                                </div>
                            </div>
            ...
            <div id="news-list-container">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="divide-y divide-gray-100" id="news-list">
                        @forelse($news as $new)
                            <div class="p-6 hover:bg-gray-50 transition-colors duration-200 group news-item"
                                ...
                                <div class="flex flex-col md:flex-row md:items-start gap-6">
                                    ...
                                    <div class="flex items-center gap-2 mt-4 md:mt-0">
                                        <button
                                            onclick="toggleEditForm('edit-form-{{ $new->id }}', 'news-{{ $new->id }}')"
                                            class="text-sm font-medium px-4 py-2 rounded-lg bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all flex items-center">
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <input type="date" name="date_news"
                                                    value="{{ old('date_news', $new->date_news) }}" required
                                                    class="w-full px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-blue-200 focus:border-blue-500 transition-all duration-200">
                                            </div>
