<x-admin titre="{{ isset($absence) ? 'Modifier' : 'Ajouter' }} une absence"
    page_titre="{{ isset($absence) ? 'Modifier' : 'Ajouter' }} une absence" :nom_complete="Auth::guard('responsable')->user()->respo_nom . ' ' . Auth::guard('responsable')->user()->respo_prenom">
                    ...
                    <div class="p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="etudiant_id" name="etudiant_id"
                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md shadow-sm"
                                    required {{ isset($absence) ? '' : 'disabled' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select id="emploi_temps_id" name="emploi_temps_id"
                                    class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md shadow-sm"
                                    required {{ isset($absence) ? '' : 'disabled' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="flex space-x-6">
                                    <div class="flex items-center">
                                        <input class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500"
                                            type="radio" name="type" id="type_absence" value="absence"
                                    ...
                                    <div class="flex items-center">
                                        <input class="h-4 w-4 border-gray-300 text-blue-600 focus:ring-blue-500"
                                            type="radio" name="type" id="type_retard" value="retard"
                            ...
                            <div id="duree_container"
                                class="{{ isset($absence) && $absence->type == 'retard' ? '' : 'hidden' }}">
                    ...
                    fetch(`/absences/seances-par-classe/${classeId}`)
                        ...
                        .then(data => {
                            ...
                            data.forEach(emploi => {
                                ...
                                option.textContent =
                                    `${heureDebut.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})} à ${heureFin.toLocaleTimeString([], {hour: '2-digit', minute:'2-digit'})} - ${emploi.matiere}`;
