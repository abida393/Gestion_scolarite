...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-white">
    <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center mb-8">
            <a href="{{ route('responsable.emploi') }}" class="mr-4 p-2 rounded-full bg-white shadow-sm hover:bg-gray-50 transition">
            ...
            <form action="{{ route('responsable.storeMultiple') }}" method="POST">
                ...
                <div class="p-8 border-b border-white/20">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            <label for="classe_id" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                                </svg>
                                Classe
                            </label>
                            <select id="classe_id" name="classe_id" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white/80 backdrop-blur" required>
                        ...
                        <div>
                            <label for="filiere_id" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                </svg>
                                Filière
                            </label>
                            <select id="filiere_id" name="filiere_id" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white/80 backdrop-blur" disabled>
                        ...
                        <div>
                            <label for="formation_id" class="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <select id="formation_id" name="formation_id" class="w-full rounded-lg border-gray-300 shadow-sm focus:ring-blue-500 focus:border-blue-500 bg-white/80 backdrop-blur" disabled>
                ...
                <div class="p-8 border-b border-white/20">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-6 gap-3 mb-6">
                        @foreach(['Lundi', 'Mardi', 'Mercredi', 'Jeudi', 'Vendredi', 'Samedi'] as $jour)
                            <label class="flex items-center space-x-2 p-3 rounded-lg border border-gray-200 hover:border-blue-300 bg-white/80 backdrop-blur cursor-pointer transition-all hover:shadow-sm">
                                <input type="checkbox" name="jours[]" value="{{ $jour }}" class="rounded-full h-5 w-5 text-blue-600 border-gray-300 focus:ring-blue-500 jour-checkbox" checked>
                                <span class="font-medium text-gray-700">{{ $jour }}</span>
                            </label>
                        @endforeach
                    </div>

                    <button type="button" onclick="genererStructureEDT()" class="px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white font-medium rounded-lg shadow-md transition-all transform hover:scale-[1.02] flex items-center">
                ...
                <div id="cours-list" class="p-8">
                    <div class="text-center py-12 rounded-xl border-2 border-dashed border-gray-300 bg-white/50 backdrop-blur">
                ...
                <!-- Boutons d'action -->
                <div class="p-6 bg-gray-50/50 backdrop-blur-sm border-t border-white/20 flex justify-end space-x-4">
                    <a href="{{ route('responsable.emploi') }}" class="px-6 py-2.5 bg-white border border-gray-300 text-gray-700 font-medium rounded-lg shadow-sm hover:bg-gray-50 transition-all">
                        Annuler
                    </a>
                    <button type="submit" id="submit-btn" class="px-6 py-2.5 bg-gradient-to-r from-green-600 to-green-500 hover:from-green-700 hover:to-green-600 text-white font-medium rounded-lg shadow-md transition-all transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed" disabled>
...
<script>
    ...
    function genererStructureEDT() {
        ...
        jours.forEach(jour => {
            ...
            jourBlock.className = "mb-8 rounded-xl shadow-sm border border-gray-200 bg-white/80 backdrop-blur overflow-hidden";
            jourBlock.id = jourId;
