...
<body class="bg-gray-100 font-sans">
    ...
    <div class="max-w-7xl mx-auto py-10 px-6">
        ...
        <form action="{{ route('emploi.storeMultiple') }}" method="POST"
            class="space-y-8 bg-white p-8 rounded-lg shadow-md border border-gray-200">
            @csrf
            ...
            <div>
                ...
                <small class="text-gray-500">Maintenez la touche Ctrl (ou Cmd sur Mac) pour sélectionner plusieurs
                    jours.</small>
            </div>
            ...
            <div class="flex justify-between">
                <button type="button" onclick="generateCours()"
    ...
    <script>
        ...
        function generateTimeSlots() {
            ...
            while (currentTime < endTime) {
                ...
                const formattedStart = currentTime.toLocaleTimeString([], {
                    hour: '2-digit',
                    minute: '2-digit'
                });
                const formattedEnd = nextTime.toLocaleTimeString([], {
                    hour: '2-digit',
                    minute: '2-digit'
                });
                ...
                currentTime.setMinutes(currentTime.getMinutes() + (formattedEnd === "12:15" ? 30 :
                15)); // Pause de 30 min après le matin, sinon 15 min
            }
